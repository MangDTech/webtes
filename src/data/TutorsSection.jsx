export const TutorsSection = {
    content: `<p className="deskripsi">Pimpinan Dinas</p>
                    <h2>Struktur Organisasi</h2>
                    <p>Tim pimpinan yang berpengalaman dalam bidang pangan dan pertanian</p>`
}
