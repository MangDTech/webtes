  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold mb-4 text-footer">Sekapur Sirih</h1>
        <div className="text-sm text-gray-500 mb-2">Posted on 2017-04-03 11:27:17 | by : Dimas Dwi Randa | 4352 kali dibaca | Category:</div>
        <section className="mb-6 text-gray-700 leading-relaxed">
          ...
          <p className="mt-4">Pelaksanaan pembangunan ketahanan pangan di Sumatera Barat berdasarkan Undang-Undang Pangan Nomor 7 Tahun 1996 sebagaimana telah diubah dengan UU Nomor 18 Tahun 2012 dan Peraturan Pemerintah Nomor 68 Tahun 2002 tentang Ketahanan Pangan yang telah dituangkan ke dalam RPJMD Provinsi Sumatera Barat tahun 2010 s/d 2015.</p>
          ...
          <p className="mt-4">Semoga dengan adanya Website Dinas Pangan Provinsi Sumatera Barat ini dapat membantu masyarakat dalam penyampaian informasi publik tentang Program dan kegiatan Ketahanan Pangan  yang meliputi tiga aspek yakni 1) Aspek ketersediaan pangan, 2) aspek distribusi pangan dan 3) aspek konsumsi pangan.</p>
          ...
          <div className="mt-8">
            ...
            <div className="mt-1 font-bold">Ir. EFENDI, MP</div>
          </div>
        </section>
      </main>
      <Footer />
