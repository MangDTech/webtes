        ...
        <div className="mt-8 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 border border-indigo-200">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Untuk mendapatkan informasi pengadaan terbaru atau mengikuti proses lelang, silakan hubungi panitia pengadaan.
            </p>
            <div className="flex justify-center space-x-4">
              ...
              <button className="bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-50 px-6 py-2 rounded-lg text-sm font-medium transition-colors">
                Portal Pengadaan
              </button>
            </div>
          </div>
